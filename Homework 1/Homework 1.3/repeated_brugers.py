#Exercise 2: This program implements one of two possible schemes for the burgers equation, repeating the simulation for 
# different values of the spacing dx. The output is a plot of the evolution of the 1-norm
import numpy as np
...
for J in [101,501,1001]:#VALUES OF THE NUMBER OF POINTS TO USE
    ...
    while(frame<=frames_number):
        ...
        u_old = u_curr.copy()
        norms.append(np.linalg.norm(u_curr, ord = 1))
        frame+=1
        time+=dt
