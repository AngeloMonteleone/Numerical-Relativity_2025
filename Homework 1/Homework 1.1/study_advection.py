#Exercise 1: code which implements FTCS, Lax-Friedrichs, Lax-wendroff, Leapfrog methods for a gaussian initial profile. 
...
if(method == "FTCS"):
    ...
    plt.savefig("Norm_{}_J{}_N{}.png".format(method,J,N))
else:
